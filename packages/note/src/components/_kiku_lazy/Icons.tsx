...
export function NotebookPenIcon(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      ...
      <path d="M2 14h4" />
      <path d="M2 18h4" />
      <path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L11.3 8.713a1 1 0 0 0-.3.7v4h4a1 1 0 0 0 .7-.288z" />
    </svg>
  );
}
